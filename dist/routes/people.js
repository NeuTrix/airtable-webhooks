...
const base = new airtable_1.default({ apiKey: process.env.AIRTABLE_KTK_PAT_KEY })
    .base(process.env.AIRTABLE_KTK_DATA_BASE_ID || '');
const table = base(process.env.AIRTABLE_KTK_TABLE_ID_PEOPLE || '');
